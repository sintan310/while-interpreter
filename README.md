...
右側の「Releases」 v1.2.1 のリリースから while-v1.2.1-release-Win10-64bit.zip を入手し、
展開してから  while-v1.2.1-release-Win10-64bit.exe をダブルクリックして使ってください。
下記リンクからも入手できます：
https://github.com/shinnya-sato/while-interpreter/releases/download/v1.2.1-release/while-v1.2.1-release-Win10-64bit.zip
